                  ...
                  Padding(
                    ...
                    child: Row(crossAxisAlignment: CrossAxisAlignment.center, children: [
                      Expanded(
                        child: RichText(
                          text: TextSpan(
                            text: getTranslated('hold_Id', context)!, style: robotoRegular.copyWith(color: Colors.black, fontSize: Dimensions.fontSizeDefault),
                            children: <TextSpan>[
                              TextSpan(text: widget.customerCard.userIndex.toString() , style: robotoBold.copyWith(color: Colors.black, fontSize: Dimensions.fontSizeDefault)),
                            ],
                          ),
                        ),
                      ),
