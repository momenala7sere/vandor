                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        decoration: BoxDecoration(
                                          ...
                                          border: Border.all(width: .5, color: Theme.of(context).primaryColor.withValues(alpha:.7)),
                                        ),
                                      ...
                                      return TextField(
                                        ...
                                        decoration: InputDecoration(
                                          ...
                                          label : Text.rich(TextSpan(children: [
                                            TextSpan(text: getTranslated('author_creator_artist', context), style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeLarge, color: Theme.of(context).hintColor.withValues(alpha:.75))),
                                          ])),
                                    ...
                                    fieldViewBuilder: (context, controller, node, onComplete) {
                                      ...
                                      return TextField(
                                        ...
                                        decoration: InputDecoration(
                                          ...
                                          label : Text.rich(TextSpan(children: [
                                            TextSpan(text: getTranslated('publishing_house', context), style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeLarge, color: Theme.of(context).hintColor.withValues(alpha:.75))),
                                          ])),
                                          border: InputBorder.none,
                                          focusedBorder: OutlineInputBorder(borderSide: BorderSide(color: Theme.of(context).primaryColor)),
                                          enabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(8),
