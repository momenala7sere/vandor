...
class _ClearanceProductWidgetState extends State<ClearanceProductWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    if(widget.products.product!.clearanceSale?.discountType == 'flat' || widget.products.product!.clearanceSale?.discountType == 'amount') {
      double _minVariationPrice = (widget.products.product?.variation != null && widget.products.product!.variation!.isNotEmpty)
      ...
      if(_minVariationPrice == 0) {
        _minVariationPrice = widget.products.product!.unitPrice!;
      }

      print("====MinVariationPrice======>>${_minVariationPrice}");
      ...
      if(double.parse(discountedPrice) < _minVariationPrice && (0 > double.parse(discountedPrice)) ) {
