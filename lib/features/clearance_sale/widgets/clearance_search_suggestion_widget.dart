                  ...
                  return Material(child: TextFormField (
                    ...
                    onFieldSubmitted: (value) {
                      if(controller.text.trim().isNotEmpty) {
                        // clearanceController.getSearchProductList(
                        //     Provider.of<ProfileController>(context, listen: false).userId.toString(),
                        //     1, context, 'en', controller.text, reload: false);
                      }else {
                    ...
                    decoration: InputDecoration(
                       ...
                       hintText: getTranslated('search_product', context),
                        hintStyle: robotoRegular.copyWith(color: Colors.red),
                        suffixIcon: SizedBox(width: controller.text.isNotEmpty? 70 : 50,
                          child: Row(children: [
                            ...
                            InkWell(onTap: (){
                              if(controller.text.trim().isNotEmpty) {
                                focusNode.unfocus();
                                // clearanceController.saveSearchAddress( controller.text.toString());
                                // clearanceController.searchProduct( query : controller.text.toString(), offset: 1);
