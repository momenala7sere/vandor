                          ...
                          children: [
                            ...
                            if (clearanceSaleController.clearanceConfigModel?.discountType == 'product_wise')...[
                              ...
                              ClearanceProductDiscountTextFieldWidget(
                                  ...
                                  onChanged: (value) {
                                    TextEditingController _controller =  clearanceSaleController.clearanceSaleAddModel[widget.index].amountController;
                                    String _discountType =  clearanceSaleController.clearanceSaleAddModel[widget.index].type!;
                                    ...
                                    } else if (hasVariation && _discountType == 'amount' && double.tryParse(_controller.text)! < result.minPrice) {
                                      setState(() {
                                        errorText = getTranslated('discount_amount_cannot_less_product_price', context);
                                        isWrongAmount = true;
                                        clearanceSaleController.clearanceSaleAddModel[widget.index].isWrongAmount = true;
                                      });
                                    } else if(hasVariation && _discountType == 'amount' && double.tryParse(_controller.text)! > result.maxPrice) {
                                      setState(() {
                                        errorText = getTranslated('discount_amount_cannot_grater_then_product_price', context);
                                        isWrongAmount = true;
                                        clearanceSaleController.clearanceSaleAddModel[widget.index].isWrongAmount = true;
                                      });
                                    } else if(!hasVariation && _discountType == 'amount' && widget.product!.unitPrice! < double.tryParse(_controller.text)!) {
                                      setState(() {
                                        errorText = getTranslated('discount_amount_cannot_grater_then_product_price', context);
                                        isWrongAmount = true;
                                        clearanceSaleController.clearanceSaleAddModel[widget.index].isWrongAmount = true;
                                      });
                                    }else if(_discountType == 'percent' && double.tryParse(_controller.text)! > 100) {
                                      setState(() {
